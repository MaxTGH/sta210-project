...
>>>>>>> 6d8feb511a4d6b93650ff960973677ff08539561
...
events |>
  ggplot(aes(x = disaster_type, y = log_total_damage_000_us)) +
  geom_boxplot() + 
  labs(
    x = "Disaster Type",
    y = "Log Total Economic Damage (Thousands of USD)",
    title = "Distribution of Log Total Economic Damage for Each Disaster Type "
  )
```
