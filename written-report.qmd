...
We were first drawn to this research question because were intrigued by this data; we were amazed by the granularity and the surprising breadth of information in this data. However, we realized that doing research on this matter could have real, practical uses.
...
2.  duration - duration in days of the disaster (quantitative)
    ...
    events |>
      ...
      labs(
        x = "Log of Duration in Days",
        y = "Log Economic Losses (Thousand, USD)",
        title = "Relationship between Duration of Natural Disaster and Total Economic Damage",
