...
2.  duration - duration in days of the disaster (quantitative)
    ...
    There seems to be a weak positive linear relationship between the log of duration in days with log of total economic damage (in thousands of dollars). There is a lot of variability in the response variable when the log of duration in days is low, but the variability decreases as the x value increases. There are outliers present throughout the graph.
