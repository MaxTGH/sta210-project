...
We are choosing the below model because after conducting cross-validation, we discovered that this model a higher r-squared compared to the model with the interaction effect.
